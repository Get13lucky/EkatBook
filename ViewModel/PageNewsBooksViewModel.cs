...
namespace EkatBooks
{
    public class PageNewsBooksViewModel
    {
        ...
        public async Task LoadBooksAsyncDowntoPrice()
        {
            ...
            var books = await _context.Books
                                      ...
                                      .Where(b => _context.BookTrends
                                                           .Any(bt => bt.IdTrend == 1 && bt.IdBook == b.IdBook))  // Фильтруем книги по тренду "Новинки"
