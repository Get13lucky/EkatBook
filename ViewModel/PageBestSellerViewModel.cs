...
namespace EkatBooks
{
    public class PageBestSellerViewModel
    {
        ...
        public PageBestSellerViewModel()
        {
        ...
        public async Task LoadBooksAsyncDowntoPrice()
        {
            ...
            var books = await _context.Books
                                      ...
                                      .Where(b => _context.BookTrends
                                                           .Any(bt => bt.IdTrend == 2 && bt.IdBook == b.IdBook))  // Фильтруем книги по тренду "Новинки"
