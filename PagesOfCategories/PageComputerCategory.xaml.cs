...
{
    /// <summary>
    /// Логика взаимодействия для PageComputerCategory.xaml
    /// </summary>
    public partial class PageComputerCategory : Page
    {
        public PageComputerCategory()
        {
            InitializeComponent();
            LoadDataAsync();
        }
        ...
        {
            var viewModel = (ComputerViewModel)DataContext;
