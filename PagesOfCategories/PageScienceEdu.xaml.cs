...
{
    /// <summary>
    /// Логика взаимодействия для PageScienceEdu.xaml
    /// </summary>
    public partial class PageScienceEdu : Page
    {
        public PageScienceEdu()
        {
            InitializeComponent();
            LoadDataAsync();
        }
        ...
        {
            var viewModel = (ScienceEduViewModel)DataContext;
