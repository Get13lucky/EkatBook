...
{
    /// <summary>
    /// Логика взаимодействия для PageBestSeller.xaml
    /// </summary>
    public partial class PageBestSeller : Page
    {
        public PageBestSeller()
        {
            InitializeComponent();
            LoadDataAsync();
        }
        ...
        {
            var viewModel = (PageBestSellerViewModel)DataContext;
