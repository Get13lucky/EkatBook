...
{
    /// <summary>
    /// Логика взаимодействия для PageNewsBooks.xaml
    /// </summary>
    public partial class PageNewsBooks : Page
    {
        public PageNewsBooks()
        {
            InitializeComponent();
            LoadDataAsync();
        }
        ...
        {
            var viewModel = (PageNewsBooksViewModel)DataContext;
